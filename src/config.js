...
// 2. Add Email Services → connect Gmail/Outlook → copy Service ID
// 3. Create Email Templates → copy Template ID
// 4. Account → API Keys → copy Public Key
// Template variables to map: {{from_name}} {{reply_to}} {{service_interest}} {{message}}
